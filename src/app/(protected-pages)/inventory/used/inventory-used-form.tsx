...
type InventoryUsedFormProps<TSchema extends ZodTypeAny> = {
...
export function InventoryUsedForm<TSchema extends ZodTypeAny>({
    onSubmit,
    isPending,
    submitLabel = "Submit",
    schema,
    onSuccess,
}: InventoryUsedFormProps<TSchema>) {
    ...
    const form = useForm<z.infer<TSchema>>({
        ...
        defaultValues: {
            ...
            item_sku: "",
            quantity: "",
            loaded_by_id: employee.employee_id,
